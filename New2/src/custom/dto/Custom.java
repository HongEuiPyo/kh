...
public class Custom extends CustomDaoImpl {
	...
	private String custom_board_attachment;
	...
	public String getCustom_board_attachment() {
		return custom_board_attachment;
	}
	public void setCustom_board_attachment(String custom_board_attachment) {
		this.custom_board_attachment = custom_board_attachment;
	}
	@Override
	public String toString() {
		return "Custom [custom_board_no=" + custom_board_no + ", user_no=" + user_no + ", user_nickname="
				+ user_nickname + ", attach_no=" + attach_no + ", custom_board_title=" + custom_board_title
				...
				+ ", custom_board_attachment=" + custom_board_attachment + "]";
	}
