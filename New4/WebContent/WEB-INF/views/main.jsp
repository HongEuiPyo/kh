...
<body>
	...
	<div class="main_text1">
		<h1>BEST 칵테일 레시피</h1>
		<div class="contents1">이번주 선정 칵테일 레시피.</div>
				...
				<div id="demo" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						...
						<div class="carousel-item">
							<img class="d-block w-100" src="/resources/img/official_cocktail/Cuba Libre.jpg"
								alt="Second slide">
							<div class="carousel-caption d-none d-md-block">
								<h5 style="color: #f0f4f5">쿠바 리브레(Cuba Libre)</h5>
							</div>
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="/resources/img/official_cocktail/Dry Martini.jpg"
								alt="Third slide">
							<div class="carousel-caption d-none d-md-block">
								<h5 style="color: black">드라이 마티니(Dry Martini)</h5>
							</div>
						</div>
						<!-- / 슬라이드 쇼 끝 -->
						<!-- 왼쪽 오른쪽 화살표 버튼 -->
		...
		<div class="main_text1">
			...
			<div class="contents1">이번주 선정 일반인 레시피.</div>
				...
				<div class="photo_slide" style="width: 569px; height: 426.75px">
					<div id="demo2" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							...
							<div class="carousel-item active">
								<!--가로-->
								<img class="d-block w-100" src="/resources/img/official_cocktail/official_cocktail_1.jpg"
									alt="First slide">
								<div class="carousel-caption d-none d-md-block">
									<h5 style="color: #f0f4f5"></h5>
								</div>
							</div>
							<div class="carousel-item">
								<img class="d-block w-100" src="/resources/img/official_cocktail/official_cocktail_2.jpg"
									alt="Second slide">
								<div class="carousel-caption d-none d-md-block">
									<h5 style="color: #f0f4f5"></h5>
								</div>
							...
							<div class="carousel-item">
								<img class="d-block w-100" src="/resources/img/official_cocktail/official_cocktail_3.jpg"
									alt="Third slide">
								<div class="carousel-caption d-none d-md-block">
									<h5 style="color: #f0f4f5"></h5>
								</div>
