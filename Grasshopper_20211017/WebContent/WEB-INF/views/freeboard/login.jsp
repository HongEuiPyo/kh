...
<form action="/member/login" method="post" class="form-horizontal">
	<div class="form-group">
		<label for="userid" class="control-label">이메일</label>
		<input type="text" id="userid" name="useremail" class="form-control"/>
	</div>
	<div class="form-group">
		<label for="userpw" class="control-label">패스워드</label>
		<input type="text" id="userpw" name="userpassword" class="form-control"/>
	</div>
