...
.map_wrap {position:relative;width:100%;height:850px; margin-left: 135px;}
...
<div class="map_wrap">
    <div id="map" style="margin-top:60px; padding:50px 30px 30px 0; border-radius: 15px; width:80%;height:100%;overflow:hidden;"></div>
